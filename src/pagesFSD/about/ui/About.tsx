    ...
    <div className={cn("page", s.aboutPage)}>
      <main>
        <Hero
          title={page.title}
          subtitle={
            "<p>«Строительные технологии» - команда профессионалов с многолетним опытом оснащения строительных объектов комплектующих для опалубки и строительных лесов. Позвоните нам, и получите грамотную консультацию от специалистов отдела продаж.</p><p>Выбирая Компанию «Строительные технологии» в качестве партнера, Вы можете быть уверены в качестве предоставляемых нами оборудования и материалов.</p>"
          }
          caption={""}
          video="/video/1"
        />
